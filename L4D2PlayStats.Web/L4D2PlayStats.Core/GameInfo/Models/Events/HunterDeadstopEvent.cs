...
[FeedPartial("GameEvents/_HunterDeadstopEvent")]
public class HunterDeadstopEvent : GameEvent
{
    public override GameEventType EventType => GameEventType.HunterDeadstop;
